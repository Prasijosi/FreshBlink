...
<head>
    ...
    <title>Edit Review - {{ $review->product->product_name }} - FreshBlink</title>
        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                <div class="flex items-center">
                    <img src="{{ asset($review->product->product_image) }}" alt="{{ $review->product->product_name }}" class="w-20 h-20 object-cover rounded">
                    <div class="ml-4">
                        <h1 class="text-xl font-semibold">{{ $review->product->product_name }}</h1>
                        <p class="text-gray-600 text-sm">Edit your review</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <form action="{{ route('reviews.update', $review->id) }}" method="POST">
                    ...
                    <div class="flex justify-between items-center">
                        <a href="{{ route('reviews.index', $review->product_id) }}" class="text-gray-600 hover:text-gray-800">
                            Cancel
                        </a>
