        ...
        <div class="checkout-container">
          ...
          <form method="POST" action="checkout.php">
            <div class="form-group">
              ...
              <input type="email" value="<?php echo $_SESSION['email']; ?>" class="form-control" id="inputEmail"
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="phone" id="inputphoneNumber"
                     placeholder="Enter your phone number" value="<?php if (isset($_GET['phone'])) {
                  echo $_GET['phone'];
              } ?>" required>
            </div>
            ...
            <div class="date-time-select">
              ...
              <div class="form-group">
                ...
                <select class="form-control bg-light" required id="inlineFormCustomSelect" name="timeoption">
                  <option
                    value="10-13" <?php echo (isset($_GET['timeoption']) && $_GET['timeoption'] == "10-13") ? 'selected="selected"' : ''; ?>>
                    10:00 AM - 1:00 PM
                  </option>
                  <option
                    value="13-16" <?php echo (isset($_GET['timeoption']) && $_GET['timeoption'] == "13-16") ? 'selected="selected"' : ''; ?>>
                    1:00 PM - 4:00 PM
                  </option>
                  <option
                    value="16-19" <?php echo (isset($_GET['timeoption']) && $_GET['timeoption'] == "16-19") ? 'selected="selected"' : ''; ?>>
                    4:00 PM - 7:00 PM
                  </option>
                </select>
              </div>
