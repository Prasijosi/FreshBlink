...
<header class="py-2 bg-white border-bottom shadow-sm">
  <div class="container-fluid">
    <div class="row align-items-center">
      ...
      <!-- Logo -->
      <div
        class="col-12 col-md-2 d-flex justify-content-center justify-content-md-start align-items-center mb-2 mb-md-0">
        ...
        <a href="cart.php" class="d-flex align-items-center text-dark mx-2 text-decoration-none">
          ...
          <?php else: ?>
            <div class="dropdown mx-2">
              <button class="btn btn-link dropdown-toggle text-dark p-0" type="button" id="dropdownMenuButton"
