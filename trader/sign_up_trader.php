    ...
    <div class="col-12 d-flex align-items-center justify-content-center mt-3">
      <form class="border p-5 mt-2 w-100" method="POST" action="trader_sign_up.php" style="max-width: 600px;">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="inputAddress" placeholder="Shop Name" name="shopname"
                 value="<?php echo $_GET['shopname'] ?? ''; ?>">
        </div>

        <div class="form-group">
          <label for="exampleFormControlTextarea1">Shop Description</label>
          <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                    name="what"><?php echo $_GET['what'] ?? ''; ?></textarea>
        </div>
