...
?>
  ...
  <style>
      ...
      .action-buttons {
          display: flex;
          gap: 1rem; /* Maintain a tight gap between buttons */
          flex-wrap: wrap;
          align-items: center;
      }
          ...
          <div class="d-flex justify-content-end align-items-center">
            ...
            <form method="POST" action="#" class="d-flex align-items-center">
              <select id="sort" class="filter-select ms-1" name="status">
                <option
                  value="all" <?php echo (!isset($_POST['status']) || $_POST['status'] == 'all') ? 'selected' : ''; ?>>
                  All Products
                </option>
                <option
                    ...
                    <tr>
                      ...
                      <td colspan="2">
                        <div class="d-flex align-items-center gap-4 flex-wrap">
                                            <span
                                              class="status-badge <?php echo $verify[$i] == 1 ? 'status-approved' : 'status-pending'; ?> me-2 mb-2 mb-md-0">
                                                <?php echo $verify[$i] == 1 ? 'Approved' : 'Pending'; ?>
                                            </span>
                          <div class="action-buttons ms-2">
                            <a href="editproducts.php?productID=<?php echo $product_id[$i]; ?>"
                               class="btn btn-primary btn-sm">
                              <i class="fas fa-edit"></i>Edit
                            </a>
                            <a href="deleteproducts.php?productID=<?php echo $product_id[$i]; ?>"
